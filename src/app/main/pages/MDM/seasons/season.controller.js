(function ()
{
    ...
    /** @ngInject */
    function SeasonController(SampleData, $http, $mdToast, baseUrl2) {
        var vm = this;
              ...
              for(var i = 0; i < 4; i++) {
                ...
                if(i < count) {
                  ...
                  for(var j = 0; j < season.length; j++) {
                    ...
                    seasonData.id = season[0];
                    seasonData.start = toDateSeason(season[2]);
                    seasonData.end = toDateSeason(season[3]);
